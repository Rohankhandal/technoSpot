    ...
    e.fn.extend({
        venobox: function($) {
            ...
            return H.cb_init(A), this.each(function() {
                ...
                function ae(e) {
                    var s, i, c = (l.match(/(http:|https:|)\/\/(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/), RegExp.$3.indexOf("youtu") > -1 ? i = "youtube" : RegExp.$3.indexOf("vimeo") > -1 && (i = "vimeo"), {
                            type: i,
                            id: RegExp.$6
                        }),
                    ...
                    "vimeo" == c.type ? s = "https://player.vimeo.com/video/" : "youtube" == c.type && (s = "https://www.youtube.com/embed/"), d.html('<iframe class="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen frameborder="0" src="' + s + c.id + a + '"></iframe>'), de()
                }
